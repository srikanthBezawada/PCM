 ...
 */
public class ClusterONE extends GraphAlgorithm {
	 ...
	 */
	public ValuedNodeSetList run() throws Exception {
		Double minDensity = parameters.getMinDensity();
		AbstractNodeSetMerger merger = null;
		Seed seed;
		...
		if (state == State.FINISHED) {
			...
			//ValuedNodeSetList tempResult =  merger.mergeOverlapping(result, parameters.getSimilarityFunction(), parameters.getOverlapThreshold());
	 ...
	 */
	public void runOnGraph(Graph graph) throws Exception  {
		setGraph(graph);
		run();
	}

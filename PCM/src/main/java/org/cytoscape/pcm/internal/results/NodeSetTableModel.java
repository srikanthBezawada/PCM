...
import org.cytoscape.pcm.internal.logic.utils.UniqueIDGenerator;
import org.cytoscape.pcm.internal.results.renderer.FruchtermanReingoldLayoutAlgorithm;
import org.cytoscape.pcm.internal.results.renderer.GraphRenderer;
import org.cytoscape.pcm.internal.results.standardgraph.GraphLayoutAlgorithm;
    ...
    */
	...
	public void setProgressIcon(Icon value) {
        ...
        public Graph convertCyNetworkToGraph(CyNetwork network, String weightAttr) {
                org.cytoscape.pcm.internal.results.Graph graph = new org.cytoscape.pcm.internal.results.Graph(network);
